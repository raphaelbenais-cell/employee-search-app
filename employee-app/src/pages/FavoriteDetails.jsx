...
const FavoriteDetails = () => {
  ...
  const { findFavoriteById, toggleFavorite, isFavorite } = useEmployeeContext();
  
  const employee = findFavoriteById(id);

  if (!employee) {
    return (
      <div className="details-page">
        <div className="error-message">Favori non trouvé</div>
        <button onClick={() => navigate('/favs')} className="back-btn">
          Back
        </button>
      </div>
    );
